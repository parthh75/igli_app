...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> images = [
    commonImageView(onTap: (){Get.to(AllServices());}),
    commonImageView(onTap: (){Get.to(AllServices());},image: "https://iglifinancial.com/wp-content/uploads/2022/11/sdafffasfa-1024x683.png",title: "Register your Company",subTitle: "Incorporate your company in less than 2 weeks online through IGLI FINANCIAL."),
    commonImageView(onTap: (){Get.to(AllServices());},image: "https://iglifinancial.com/wp-content/uploads/2022/11/sghejrjs-1024x683.png",title: "LLP Registration",subTitle: "LLP registration and deed drafting including Government Fee & Stamp Duty*. in just 6199/-"),
    commonImageView(onTap: (){Get.to(AllServices());},image: "https://iglifinancial.com/wp-content/uploads/2022/11/scasvavwvwv-1024x683.png",title: "Protect Your Brand",subTitle: "Get a trademark registration and protect your brand from copycats."),
    commonImageView(onTap: (){Get.to(AllServices());},image: "https://iglifinancial.com/wp-content/uploads/2022/11/daskdnaksa-1024x683.png",title: "Startup India Registration",subTitle: "The Startup India Registration is the process of registering a startup with the Government of India."),
                            ...
                            decoration: BoxDecoration(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Text("TradeMark",style: TextStyle(color: colors000000,fontSize: 15,),)
                               ],
                             ),
                          ), Container(
                            decoration: BoxDecoration(
