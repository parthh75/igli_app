        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Name Change & Other Conditions",style: TextStyle(
                    fontWeight: FontWeight.w700,
                    color: colors000000,fontSize: 18
                )),
                ListView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: (){Get.to(ListDetailPage(
                        ...
                        onPay: nameChangeModel[index].subListTitlePay,
                        index:nameChangeModel.length,description: nameChangeModel[index].description,
                        benefits: nameChangeModel[index].benefits,
                        deliverables: nameChangeModel[index].deliverables,
                        deliverablesTab: nameChangeModel[index].deliverablesTab,
                      ...
                      child: commonListView(
                          ...
                          subListTitlePay: nameChangeModel[index].subListTitlePay,
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: ()=> Get.to(()=>ListDetailPage(
                        ...
                        onPay: marriageModel[index].subListTitlePay,
                        index:marriageModel.length,description: marriageModel[index].description,
                        benefits: marriageModel[index].benefits,
                        deliverables: marriageModel[index].deliverables,
                        deliverablesTab: marriageModel[index].deliverablesTab,
                      ...
                      child: commonListView(
                          ...
                          subListTitlePay: marriageModel[index].subListTitlePay,
