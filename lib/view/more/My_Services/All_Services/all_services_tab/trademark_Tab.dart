    ...
    return SingleChildScrollView(
      child: Column(
        children: [
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                          onTap: () {
                            Get.to(ListDetailPage(
                              ...
                              subListTitleExPay:
                                  trademarkModel[index].subListTitleEx,
                              subListTitleInPay:
                                  trademarkModel[index].subListTitleIn,
                              index: trademarkModel.length,
                              description: trademarkModel[index].description,
                              benefits: trademarkModel[index].benefits,
                              deliverables: trademarkModel[index].deliverables,
                              deliverablesTab:
                                  trademarkModel[index].deliverablesTab,
          ...
          //                       subListTitleExPay:
          //                           patentModel[index].subListTitleEx,
          //                       index: patentModel.length,
          //                       description: patentModel[index].description,
          //                       benefits: patentModel[index].benefits,
          //                       deliverables: patentModel[index].deliverables,
          //                       deliverablesTab:
          //                           patentModel[index].deliverablesTab,
          ...
          //                     subListTitleEx: patentModel[index].subListTitleEx,
