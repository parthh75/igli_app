...
Widget commonElevatedButton(
    {double? height, double? width, String? title, Color? buttonColor, double? textTopPadding, Function()? onTap, double? horizontalPadding, double? buttonTopPadding, double? buttonBottomPadding}) {
  return SizedBox(
...
Widget commonOutlineButton(
    {Function()? onTap, String? buttonText, double? width, double? height, TextStyle? textStyle, double? bottomPadding, double? topPadding, bool isIcon = false, double? horizontalPadding}) {
  return SizedBox(
    width: width ?? Get.width,
    height: height ?? 40,
...
Widget commonTextField(
  ...
  return SizedBox(
    // height: 38,
    child: TextFormField(
            decoration: InputDecoration(labelText: labelText, hintText: hintText, border: border, suffixIcon: suffixIcon, labelStyle: const TextStyle(fontSize: 15, height: 0.2)),
