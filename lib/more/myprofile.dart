            ...
            Card(
              ...
              child: Column(
               ...
               const Center(child: Icon(Icons.account_circle,size: 100,color: Colors.grey)),
                 Center(child: Text(CS.dUserName,style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold),).paddingOnly(bottom: 2,top: 5)),
                  Center(child: Text(CS.dEmail,style: const TextStyle(fontWeight: FontWeight.normal,color: Colors.grey),)),

                   Text(CS.fullName).paddingOnly(top: 20),
                  TextFormField(onTap: (){setState(() {
  isButton=true;
});
}),
                  Text(CS.dob).paddingOnly(top: 20),
                  TextFormField(),
                  Text(CS.gender,).paddingOnly(top: 20),
                  ...
                  ).paddingOnly(bottom: 20,top: 10):SizedBox()
